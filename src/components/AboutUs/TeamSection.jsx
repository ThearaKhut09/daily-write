...
const IntroSection = () => {
  ...
  const teamMembers = [
    { id: 1, color: 'var(--primary-500)', name: 'John Doe', role: 'Founder & Writer' },
    { id: 2, color: 'var(--text-secondary)', name: 'Jane Smith', role: 'Content Lead' },
    { id: 3, color: 'var(--text-primary)', name: 'Mike Johnson', role: 'Tech Editor' },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.div className="relative order-2 lg:order-1 mt-8 lg:mt-0" variants={itemVariants}>
          ...
          >
            ...
            <motion.div className="space-y-1 sm:space-y-2 mb-6 sm:mb-8" variants={itemVariants}>
              <motion.div
        ...
        {/* Right Side: Content */}
        <motion.div className="z-10 order-1 lg:order-2" variants={containerVariants}>
          ...
          >
            <motion.p variants={itemVariants}>
              We are a team of passionate students from ISTAD, dedicated to building
              an innovative blogging platform that makes sharing ideas accessible to
              everyone. As part of our project, we designed DailyWrite to provide a space
              where individuals can express their thoughts, explore diverse perspectives,
              and engage in meaningful discussions.
            </motion.p>
            <motion.p variants={itemVariants}>
              Join us on this journey to share knowledge, spark conversations, and grow
